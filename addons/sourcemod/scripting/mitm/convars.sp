...
void ConVars_Init()
{
	...
	mitm_cycle_defenders_on_wave_completion = CreateConVar("mitm_cycle_defenders_on_wave_completion", "0", "Whether to select a new set of defenders on wave completion.");
